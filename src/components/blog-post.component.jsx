    ...
    return (
        <div className="leadingPageCard">
            <Link to={`/blog/${id}`} className="flex gap-8 items-center border-b border-grey pb-5 mb-4">
                ...
                <div className="h-48 aspect-sqaure bg-grey rounded-xl">
                    <img src={banner} className="w-full h-full aspect-square object-cover rounded-xl" />
                </div>
